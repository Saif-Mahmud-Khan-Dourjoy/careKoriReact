...
import slide1 from "/images/loginIllustration.png"
...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* LEFT: logo + form */}
      <div className="relative flex items-center justify-center bg-[url('/images/loginFormBg.png')]  bg-no-repeat  bg-cover  text-white overflow-hidden">
        ...
        {/* <img className="absolute bottom-0 w-full -left-1.5" src="/images/v2.png" alt="" /> */}
        <div className="w-full max-w-md px-8">
          ...
          <form onSubmit={handleSubmit} className="">
            ...
            <button
              ...
              className="w-full rounded-lg bg-white text-[#3F5ED1] font-bold py-3 hover:bg-blue-50 transition disabled:opacity-70 mt-10"
            >
            ...
            {/* API / general error */}
            {status && (
              <div className="text-sm text-red-900 font-semibold">{status}</div>
            )}
          </form>
        </div>
      </div>
      ...
      <div className="relative bg-white flex items-center justify-center p-6 overflow-hidden">
        ...
        <div className="absolute bottom-4 md:bottom-16 flex gap-2">
          {slides.map((_, i) => (
            <button
              key={i}
              onClick={() => setIndex(i)}
