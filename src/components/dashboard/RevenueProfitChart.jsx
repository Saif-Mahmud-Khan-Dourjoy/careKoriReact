...
export default function RevenueProfitChart({ period = "Yearly", year = new Date().getFullYear(), monthlyByYear, yearly}) {
  const data = period === "Monthly" ? monthlyByYear[year] || [] : yearly

  console.log(period, year, monthlyByYear, yearly, data);
